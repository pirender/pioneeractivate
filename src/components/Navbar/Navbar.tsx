...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="mycontainer my-0 mx-auto flex items-center justify-between py-6">
          ...
          <div className="flex items-center gap-4">
              ...
              <ul className="group">
                <li className="relative group-hover:block">
                  <a href="#" className="text-white flex items-center gap-2">
                    Pi Blockchain
                    {/* <motion.div
                  className="absolute left-0 right-0 hidden group-hover:block h-0.5 bg-white origin-left"
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                  whileHover={{ scaleX: 1 }}
                ...
                /> */}
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="white"
                      className="w-[20px] h-[20px] group"
                    >
                      <path d="M11.9999 13.1714L16.9497 8.22168L18.3639 9.63589L11.9999 15.9999L5.63599 9.63589L7.0502 8.22168L11.9999 13.1714Z"></path>
                    </svg>
                  </a>
                  <ul className="absolute left-0 mt-8 w-48 bg-white text-gray-800 rounded-md shadow-lg opacity-0 group-hover:opacity-100 group-hover:block transition-opacity duration-300 hidden">
            ...
            <div className="relative group">
              <a href="#" className="text-white">
                Developers
                <motion.div
                  className="absolute left-0 right-0 h-0.5 bg-white origin-left"
                  initial={{ scaleX: 0 }}
                  whileHover={{ scaleX: 1 }}
                  transition={{ duration: 0.3 }}
                />
              </a>
              <div className="absolute left-0 mt-2 hidden group-hover:block bg-white text-black rounded-md shadow-lg">
                <ul className="py-2">
                  <li>
        ...
        {menu && (
          <motion.div
            ...
            className={`fixed top-[78px] left-0 w-full h-full bg-[#251339] flex flex-col justify-center items-center z-50 pb-[150px] m-auto`}
          >
